# From here: https://gist.github.com/jnpaulson/324ac1fa3eab1bc7f845
# Reguarding discussion here: https://github.com/joey711/phyloseq/issues/443
# 
# Allows import of Biom v2 formated biom tables run in the following way:
# 
# biom <- biomformat::read_hdf5_biom(str_c(datadir,'merged_otu_table.biom'))
# data <-import_biom2(biom) # now a phyloseq object
